...
class Demosource(Base):
	...
	def cmdSetCurrent(self, curr):
		try:
			...
			print(e)
	def cmdInterlockChange(self, closed):
		try:
			parameters = [closed]
			self.executeCommand(self.objectName, "interlockChange", parameters)
		except ApiError as e:
			print(e)
	def cmdSetHardwareBusy(self, b):
		try:
			parameters = [b]
			self.executeCommand(self.objectName, "setHardwareBusy", parameters)
		except ApiError as e:
			print(e)
	def cmdSetHardwareOn(self, b):
		try:
			parameters = [b]
			self.executeCommand(self.objectName, "setHardwareOn", parameters)
		except ApiError as e:
			print(e)
