...
class Varian(Base):
	def __init__(self, objectName):
		...
		#super(Varian, self).__init__(objectName)
	...
	def setMode(self, value):
		try:
			self.setValue(self.objectName, "mode", value)
		except ApiError as e:
			print(e)
	def getMode(self):
		try:
			return self.getValue(self.objectName, "mode")
		except ApiError as e:
			print(e)
	...
	def getMaxFramerate(self):
		try:
			return self.getValue(self.objectName, "maxFramerate")
		except ApiError as e:
			print(e)

	def getNumOfModes(self):
		try:
			return self.getValue(self.objectName, "numOfModes")
		except ApiError as e:
			print(e)

	def getModeList(self):
		try:
			return self.getValue(self.objectName, "modeList")
		except ApiError as e:
			print(e)
	...
	def cmdGuiDestroyed(self):
		try:
			...
			print(e)
	def cmdSetMaxFramerate(self):
		try:
			self.executeCommand(self.objectName, "setMaxFramerate")
		except ApiError as e:
			print(e)
	...
	def cmdSetMode(self):
		try:
			self.executeCommand(self.objectName, "setMode")
		except ApiError as e:
			print(e)
	def cmdAddConnectedVipIndex(self):
		try:
			self.executeCommand(self.objectName, "addConnectedVipIndex")
		except ApiError as e:
			print(e)
	def cmdRemoveConnectedVipIndex(self):
		try:
			self.executeCommand(self.objectName, "removeConnectedVipIndex")
		except ApiError as e:
			print(e)
	def cmdDebug(self):
		try:
			self.executeCommand(self.objectName, "debug")
		except ApiError as e:
			print(e)
	def cmdSetClippingLevel(self, level):
		try:
			parameters = [level]
			self.executeCommand(self.objectName, "setClippingLevel", parameters)
		except ApiError as e:
			print(e)
	def cmdReset(self):
		try:
			...
			print(e)
	def cmdDisableFrameRate(self, disable):
		try:
			parameters = [disable]
			self.executeCommand(self.objectName, "disableFrameRate", parameters)
		except ApiError as e:
			print(e)
	def cmdChangeTemperatures(self, temperatures):
		try:
			parameters = [temperatures]
			self.executeCommand(self.objectName, "changeTemperatures", parameters)
		except ApiError as e:
			print(e)
