...
class Demoline(Base):
	...
	def setSpacing(self, value):
		try:
			self.setValue(self.objectName, "spacing", value)
		except ApiError as e:
			print(e)
	def getSpacing(self):
		try:
			return self.getValue(self.objectName, "spacing")
		except ApiError as e:
			print(e)

	def setNumOfLines(self, value):
		try:
			self.setValue(self.objectName, "numOfLines", value)
		except ApiError as e:
			print(e)
	def getNumOfLines(self):
		try:
			return self.getValue(self.objectName, "numOfLines")
		except ApiError as e:
			print(e)

	def setTomographyMode(self, value):
		try:
			self.setValue(self.objectName, "tomographyMode", value)
		except ApiError as e:
			print(e)
	def getTomographyMode(self):
		try:
			return self.getValue(self.objectName, "tomographyMode")
		except ApiError as e:
			print(e)

	def setTrigger(self, value):
		try:
			self.setValue(self.objectName, "trigger", value)
		except ApiError as e:
			print(e)
	def getTrigger(self):
		try:
			return self.getValue(self.objectName, "trigger")
		except ApiError as e:
			print(e)
	...
	def cmdAxisBusyClear(self):
		try:
			...
			print(e)
	def cmdVerticalStartSet(self):
		try:
			self.executeCommand(self.objectName, "verticalStartSet")
		except ApiError as e:
			print(e)
	def cmdVerticalEndSet(self):
		try:
			self.executeCommand(self.objectName, "verticalEndSet")
		except ApiError as e:
			print(e)
	def cmdSnapshotTomo(self):
		try:
			self.executeCommand(self.objectName, "snapshotTomo")
		except ApiError as e:
			print(e)
	def cmdTomography(self):
		try:
			self.executeCommand(self.objectName, "tomography")
		except ApiError as e:
			print(e)
	def cmdSingleSlice(self):
		try:
			self.executeCommand(self.objectName, "singleSlice")
		except ApiError as e:
			print(e)
	def cmdVerticalScan(self):
		try:
			self.executeCommand(self.objectName, "verticalScan")
		except ApiError as e:
			print(e)
	def cmdReconstruct(self):
		try:
			self.executeCommand(self.objectName, "reconstruct")
		except ApiError as e:
			print(e)
	def cmdCancel(self):
		try:
	...
	def cmdTomographyPositionOffset(self):
		try:
			...
			print(e)
	def cmdLineScanImagerGuiDestroyed(self):
		try:
			self.executeCommand(self.objectName, "lineScanImagerGuiDestroyed")
		except ApiError as e:
			print(e)
	def cmdSaveLineScanImagerSettings(self):
		try:
			self.executeCommand(self.objectName, "saveLineScanImagerSettings")
		except ApiError as e:
			print(e)
	def cmdLoadLineScanImagerSettings(self):
		try:
			self.executeCommand(self.objectName, "loadLineScanImagerSettings")
		except ApiError as e:
			print(e)
	def cmdReconstructPrivate(self):
		try:
			self.executeCommand(self.objectName, "reconstructPrivate")
		except ApiError as e:
			print(e)
	def cmdAxisPositionChanged(self):
		try:
			...
			print(e)
	def cmdIncomingLines(self):
		try:
			self.executeCommand(self.objectName, "incomingLines")
		except ApiError as e:
			print(e)
	def cmdInitTriggerStartLine(self):
		try:
			self.executeCommand(self.objectName, "initTriggerStartLine")
		except ApiError as e:
			print(e)
	def cmdSetImageInput(self, path, snapshotOnly):
		try:
			...
			print(e)
	def cmdAddSphere(self):
		try:
			self.executeCommand(self.objectName, "addSphere")
		except ApiError as e:
			print(e)
	def cmdSetSTL(self, path):
		try:
			...
			print(e)
	def cmdProjectedSpheres(self):
		try:
			self.executeCommand(self.objectName, "projectedSpheres")
		except ApiError as e:
			print(e)
	def cmdSetCustomProjctionMatrix(self, mat):
		try:
			...
			print(e)
	def cmdRenderMeshInit(self, path):
		try:
			parameters = [path]
			self.executeCommand(self.objectName, "renderMeshInit", parameters)
		except ApiError as e:
			print(e)
	def cmdRenderMesh(self):
		try:
			self.executeCommand(self.objectName, "renderMesh")
		except ApiError as e:
			print(e)
