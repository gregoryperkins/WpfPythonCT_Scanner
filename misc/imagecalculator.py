...
class Imagecalculator(Base):
	...
	def cmdReadyDelayTimerSlot(self):
		try:
			...
			print(e)
	def cmdCopyMatrices(self, fromm, to):
		try:
			parameters = [fromm, to]
			self.executeCommand(self.objectName, "copyMatrices", parameters)
		except ApiError as e:
			print(e)
	def cmdFunction(self):
		try:
			self.executeCommand(self.objectName, "function")
		except ApiError as e:
			print(e)
