...
class Distortionmap(Base):
	...
	def cmdReadyDelayTimerSlot(self):
		try:
			...
			print(e)
	def cmdFinalize(self):
		try:
			self.executeCommand(self.objectName, "finalize")
		except ApiError as e:
			print(e)
	def cmdProcess(self):
		try:
			self.executeCommand(self.objectName, "process")
		except ApiError as e:
			print(e)
	def cmdReslice(self):
		try:
			self.executeCommand(self.objectName, "reslice")
		except ApiError as e:
			print(e)
