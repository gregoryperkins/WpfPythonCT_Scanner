...
class Serial(Base):
	...
	def cmdRead(self):
		try:
			self.executeCommand(self.objectName, "read")
		except ApiError as e:
			print(e)
	def cmdWrite(self):
		try:
			self.executeCommand(self.objectName, "write")
		except ApiError as e:
			print(e)
	def cmdEmitReadyRead(self):
		try:
			self.executeCommand(self.objectName, "emitReadyRead")
		except ApiError as e:
			print(e)
