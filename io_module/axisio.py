...
class Axisio(Base):
	...
	def cmdSetDeviceOutput(self, number, value):
		try:
			...
			print(e)
	def cmdNumOfInput(self):
		try:
			self.executeCommand(self.objectName, "numOfInput")
		except ApiError as e:
			print(e)
	def cmdAxisConnected(self):
		try:
			self.executeCommand(self.objectName, "axisConnected")
		except ApiError as e:
			print(e)
	def cmdInputUpdate(self):
		try:
			self.executeCommand(self.objectName, "inputUpdate")
		except ApiError as e:
			print(e)
	def cmdAnalogInputUpdate(self, input, value):
		try:
			parameters = [input, value]
			self.executeCommand(self.objectName, "analogInputUpdate", parameters)
		except ApiError as e:
			print(e)
