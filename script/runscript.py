...
class Runscript(Base):
	...
	def cmdReadyDelayTimerSlot(self):
		try:
			...
			print(e)
	def cmdStopScript(self):
		try:
			self.executeCommand(self.objectName, "stopScript")
		except ApiError as e:
			print(e)
	def cmdDestroy(self):
		try:
			...
			print(e)
	def cmdLoadScript(self, filename):
		try:
			parameters = [filename]
			self.executeCommand(self.objectName, "loadScript", parameters)
		except ApiError as e:
			print(e)
	def cmdLoadRecentScript(self):
		try:
			self.executeCommand(self.objectName, "loadRecentScript")
		except ApiError as e:
			print(e)
