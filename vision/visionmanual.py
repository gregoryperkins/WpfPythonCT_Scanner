...
class Visionmanual(Base):
	...
	def cmdProcess(self, image):
		try:
			...
			print(e)
	def cmdPassFail(self):
		try:
			self.executeCommand(self.objectName, "passFail")
		except ApiError as e:
			print(e)
	def cmdSetCurrentImageArray(self):
		try:
			self.executeCommand(self.objectName, "setCurrentImageArray")
		except ApiError as e:
			print(e)
