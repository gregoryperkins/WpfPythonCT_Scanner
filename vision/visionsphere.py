...
class Visionsphere(Base):
	...
	def cmdProcess(self, image):
		try:
			...
			print(e)
	def cmdSphereX(self, index):
		try:
			parameters = [index]
			self.executeCommand(self.objectName, "sphereX", parameters)
		except ApiError as e:
			print(e)
	def cmdSphereY(self, index):
		try:
			parameters = [index]
			self.executeCommand(self.objectName, "sphereY", parameters)
		except ApiError as e:
			print(e)
	def cmdSphereDiameter(self, index):
		try:
			parameters = [index]
			self.executeCommand(self.objectName, "sphereDiameter", parameters)
		except ApiError as e:
			print(e)
	def cmdSphereDetected(self):
		try:
			self.executeCommand(self.objectName, "sphereDetected")
		except ApiError as e:
			print(e)
	def cmdNumOfSpheres(self):
		try:
			self.executeCommand(self.objectName, "numOfSpheres")
		except ApiError as e:
			print(e)
